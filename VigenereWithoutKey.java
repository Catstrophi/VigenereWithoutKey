...
public class VigenereWithoutKey {
    public static void main(String[] args) throws FileNotFoundException {
        //region key length finder

        // creates scanner to bring in our word
        Scanner scan = new Scanner(new File("src/Other/EncryptedText.dat"));
        ...
        for (int n = 0; n < key_length; n++){
            ...
            Scanner freq_scanner = new Scanner(new File("src/Other/frequency.txt"));
